...
export default function LoginPage() {
  ...
  async function handleVerifyAndLogin() {
    ...
    try {
      ...
      // Step 2 — sign in with correct provider
      const provider = userRole === "dealer"
        ? "dealer-login"
        : "customer-login";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gw-400 text-sm mt-1">
            {step === "form"
              ? "Login to your GreenWheels account"
        ...
        {registered && (
          <div style={{ border: "1px solid #14532d" }}
            className="bg-gw-900/50 text-lime-400 text-sm rounded-xl
                       px-4 py-3 mb-4 text-center">
            {registered === "dealer"
              ? "🔧 Dealer account created! Login to access your dashboard."
        ...
        <div className="card">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative my-2">
                ...
                <div className="relative flex justify-center text-xs
                                text-gw-600 bg-gw-900 px-2 w-fit mx-auto">
                  or
                </div>
              </div>
          ...
          <p className="text-center text-sm text-gw-400 mt-6">
            No account yet?{" "}
            <Link href="/register"
              className="text-lime-400 font-semibold hover:text-white">
              Register
            </Link>
            {" · "}
            <Link href="/dealer/register"
              className="text-lime-400 font-semibold hover:text-white">
              Dealer? Register here
            </Link>
          </p>
        </div>
