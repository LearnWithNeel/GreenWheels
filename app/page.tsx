            ...
            <section style={{ borderTop: "1px solid #14532d" }}
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <h2 className="font-black text-3xl text-white mb-4">
                        Own a Workshop? Join GreenWheels 🔧
                    </h2>
                    <p className="text-gw-400 text-lg mb-8">
                        Register as a verified dealer and start receiving EV retrofit
                        orders in your city. Keep 90% of every order value.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/dealer/register" className="btn-primary text-base
                                               py-4 px-8">
                            Register as Dealer →
                        </Link>
